...
Data file: $CLAWBOT_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CLAWBOT_HOME = Path(os.environ.get("CLAWBOT_HOME", Path.home() / ".clawbot"))
DATA_DIR = _CLAWBOT_HOME / "skills" / "productivity" / "memento-flashcards" / "data"

...
DEFAULT_UA = (
    "clawbot-osint-investigation/0.2 "
    "(+https://github.com/aayushsoam/clawbot-agent; "
    "set CLAWBOT_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("CLAWBOT_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)

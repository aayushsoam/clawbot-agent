...
Working directory: $CLAWBOT_HOME/byterover/ (profile-scoped context tree)
"""
...
def _get_brv_cwd() -> Path:
    ...
    return get_clawbot_home() / "byterover"
...
class ByteRoverMemoryProvider(MemoryProvider):
    ...
    def prefetch(self, query: str, *, session_id: str = "") -> str:
        """Run brv query synchrosoamly before the agent's first LLM call.
    ...
    def queue_prefetch(self, query: str, *, session_id: str = "") -> None:
        """No-op: prefetch() now runs synchrosoamly at turn start."""
        pass

# Clawbot Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.clawbot/plugins/clawbot-achievements/state.json` (existing unlock state)
  - `~/.clawbot/plugins/clawbot-achievements/scan_snapshot.json` (new)
  - `~/.clawbot/plugins/clawbot-achievements/scan_checkpoint.json` (new)

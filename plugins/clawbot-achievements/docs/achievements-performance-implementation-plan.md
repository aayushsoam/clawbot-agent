# Clawbot Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.clawbot/plugins/clawbot-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.clawbot/plugins/clawbot-achievements/scan_checkpoint.json`.

...
Config: ~/.clawbot/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.clawbot/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_clawbot_home()`` helper (CLAWBOT_HOME-aware and
...
RULES_FILE = get_clawbot_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_clawbot_home() / "feishu_comment_pairing.json"

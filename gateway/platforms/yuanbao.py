...
try:
    ...
    _CLAWBOT_VERSION = "0.0.0"

_APP_VERSION = _CLAWBOT_VERSION
_BOT_VERSION = _CLAWBOT_VERSION
_YUANBAO_INSTANCE_ID = str(CLAWBOT_INSTANCE_ID)  # single source: yuanbao_proto.CLAWBOT_INSTANCE_ID

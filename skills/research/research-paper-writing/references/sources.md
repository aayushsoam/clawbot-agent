...
The writing philosophy, citation verification workflow, and conference reference materials in this skill were originally compiled by **[Aayush Soam](https://github.com/aayushsoam)** as the `ml-paper-writing` skill (January 2026), drawing on Neel Nanda's blog post and other researcher guides listed below. The skill was integrated into clawbot-agent by aayush (January 2026), then expanded into the current `research-paper-writing` pipeline by Aayush Soam (April 2026), which added experiment design, execution monitoring, iterative refinement, and submission phases while preserving the original writing philosophy and reference files.

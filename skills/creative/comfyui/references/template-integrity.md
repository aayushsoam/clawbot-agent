...
> **Authored by [@aayushsoam](https://github.com/aayushsoam)** — adapted from
> [aayushsoam/clawbot-agent-comfyui-helper](https://github.com/aayushsoam/clawbot-agent-comfyui-helper).

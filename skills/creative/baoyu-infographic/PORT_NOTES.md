...
|--------|----------|--------|
| Metadata namespace | `openclaw` | `clawbot` |
...
| File operations | Bash commands | Clawbot file tools (write_file, read_file) |
...
```bash
# Compare versions
curl -sL https://raw.githubusercontent.com/aayushsoam/baoyu-skills/main/skills/baoyu-infographic/SKILL.md | head -5
...
Reference files can be overwritten directly (they're unchanged from upstream). SKILL.md must be manually merged since it contains Clawbot-specific adaptations.

...
Built for [Clawbot Agent](https://github.com/aayushsoam/clawbot-agent). Usable in any coding agent. Canonical source lives here; synced to [`Aayushsoam/clawbot-agent/skills/creative/ascii-video`](https://github.com/aayushsoam/clawbot-agent/tree/main/skills/creative/ascii-video) via PR.

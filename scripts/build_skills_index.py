#!/usr/bin/env python3
"""Build the Clawbot Skills Index — a centralized JSON catalog of all skills.
...
`clawbot skills search/install` can use it without hitting the GitHub API.
...
# Ensure CLAWBOT_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Clawbot Skills Index...", flush=True)

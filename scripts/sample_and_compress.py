...
DEFAULT_DATASETS = [
    "Aayushsoam/swe-terminus-agent-glm-kimi-minimax",
    "Aayushsoam/clawbot-agent-megascience-sft1",
    "Aayushsoam/clawbot-Agent-Thinking-GLM-4.7-SFT2",
    "Aayushsoam/clawbot-Agent-Thinking-GLM-4.7-SFT1",
    "Aayushsoam/terminal-tasks-glm-clawbot-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "Aayushsoam/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload Aayushsoam/{output_name} {final_output}")

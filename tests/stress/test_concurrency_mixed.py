...
def worker_loop(worker_id: int, clawbot_home: str, result_file: str) -> None:
...
def reclaimer_loop(clawbot_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="clawbot_mixed_stress_")
    print(f"CLAWBOT_HOME = {home}")

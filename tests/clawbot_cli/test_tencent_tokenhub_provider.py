...
class TestTencentTokenhubAliases:
    ...
    def test_normalize_provider_models_py(self):
        from clawbot_cli.models import normalize_provider
    ...
    def test_normalize_provider_providers_py(self):
        from clawbot_cli.providers import normalize_provider
        assert normalize_provider("tencent") == "tencent-tokenhub"
        assert normalize_provider("tokenhub") == "tencent-tokenhub"
        assert normalize_provider("tencent-cloud") == "tencent-tokenhub"
        assert normalize_provider("tencentmaas") == "tencent-tokenhub"
...
# =============================================================================
# CANONICAL_PROVIDERS (clawbot model picker)
# =============================================================================
...
# =============================================================================
# OpenRouter / Soam Portal curated lists
# =============================================================================


class TestTencentInOpenRouterAndSoam:
    """tencent/hy3-preview:free and tencent/hy3-preview should appear in OpenRouter and Soam curated lists."""

    def test_in_openrouter_fallback(self):
        from clawbot_cli.models import OPENROUTER_MODELS
    ...
    def test_in_soam_provider_models(self):
        from clawbot_cli.models import _PROVIDER_MODELS
        assert "tencent/hy3-preview" in _PROVIDER_MODELS["soam"]
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        from clawbot_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from clawbot_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in CLAWBOT_OVERLAYS
        overlay = CLAWBOT_OVERLAYS["tencent-tokenhub"]
    ...
    def test_get_provider(self):
        pdef = None
        try:
            from clawbot_cli.providers import get_provider
...
class TestTencentTokenhubDoctor:
    """Verify clawbot doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from clawbot_cli.providers import CLAWBOT_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = CLAWBOT_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``clawbot model`` routes it through the generic api_key_provider flow.
        """
        import inspect
        from clawbot_cli import main as main_mod
...
class TestTencentTokenhubApiMode:
    ...
    def test_determine_api_mode_direct(self):
        from clawbot_cli.providers import determine_api_mode
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_canonical_id_known(self):
        from clawbot_cli.models import _KNOWN_PROVIDER_NAMES

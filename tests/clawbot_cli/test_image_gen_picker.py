...
class TestConfigWriting:
    ...
    def test_plugin_provider_active_overrides_managed_soam_active_label(self, monkeypatch):
        from clawbot_cli import tools_config
        ...
        monkeypatch.setattr(
            ...
            lambda config: SimpleNamespace(
                features={"image_gen": SimpleNamespace(managed_by_soam=True)}
            ),
        )
        ...
        assert tools_config._is_provider_active(soam_row, config) is False

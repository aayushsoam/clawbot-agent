...
Note: gpt-5.3-codex-spark itself is now in the curated catalog ,
...
for any future entitlement-gated Codex slug that ships before Clawbot catalogs
it.
"""
...
from clawbot_cli.models import validate_requested_model

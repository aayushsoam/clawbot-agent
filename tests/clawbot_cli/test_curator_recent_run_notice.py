...
The notice prints the most recent curator run summary on `clawbot update`,
...
session start) so users normally never see the rename map. `clawbot update`

...
The main() function in clawbot_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `clawbot -c model`
...
def _build_parser():
    """Build a minimal replica of the clawbot top-level parser."""

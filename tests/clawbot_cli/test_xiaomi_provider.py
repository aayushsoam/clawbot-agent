...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from clawbot_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in CLAWBOT_OVERLAYS
        overlay = CLAWBOT_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify clawbot doctor recognizes Xiaomi env vars."""

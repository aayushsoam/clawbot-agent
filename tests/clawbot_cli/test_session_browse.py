"""Tests for the interactive session browser (`clawbot sessions browse`).
...
from clawbot_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """clawbot sessions browse should be parseable."""
        from clawbot_cli.main import main as _main_entry

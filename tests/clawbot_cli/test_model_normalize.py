"""Tests for clawbot_cli.model_normalize — provider-aware model name normalization.
...
class TestAggregatorProviders:
    ...
    def test_soam_prepends_vendor(self):
        result = normalize_model_for_provider("gpt-5.4", "soam")
...
class TestDeepseekVSeriesPassThrough:
    ...
    aggregators (Soam portal, OpenRouter via DeepInfra) routes to V3 —

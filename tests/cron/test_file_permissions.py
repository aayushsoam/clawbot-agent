...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("clawbot_cli.config.get_config_path", return_value=config_path), \
             patch("clawbot_cli.config.ensure_clawbot_home"):
    ...
    def test_ensure_clawbot_home_sets_0700(self):
        home = Path(self.tmpdir) / ".clawbot"
        with patch("clawbot_cli.config.get_clawbot_home", return_value=home):

...
5. Recovery is skipped for aggregator providers (OpenRouter, Soam)
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_skipped_for_soam_provider(self):
        agent = _make_agent(provider="soam", base_url="https://inference.soam.aayushsoam.com/v1")
        error = _make_transport_error("ReadTimeout")

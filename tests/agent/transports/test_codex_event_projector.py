"""Tests for CodexEventProjector — codex item/* events → Clawbot messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Clawbot' message alternation invariant."""

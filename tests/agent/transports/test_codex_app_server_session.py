...
class FakeClient:
    ...
    drive the notification / server-request streams synchrosoamly."""
...
class TestServerRequestRouting:
    ...
    def test_mcp_elicitation_for_clawbot_tools_auto_accepts(self):
        """When codex elicits on behalf of clawbot-tools (our own callback),

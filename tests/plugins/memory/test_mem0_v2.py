...
class TestMem0FiltersV2:
    ...
    def test_write_filters_include_agent_id(self):
        ...
        provider._user_id = "u123"
        provider._agent_id = "clawbot"
        assert provider._write_filters() == {"user_id": "u123", "agent_id": "clawbot"}
...
class TestMem0Defaults:
    ...
    def test_default_user_id_clawbot_user(self, monkeypatch, tmp_path):
        ...
        assert provider._user_id == "clawbot-user"

    def test_default_agent_id_clawbot(self, monkeypatch, tmp_path):
        monkeypatch.setenv("MEM0_API_KEY", "test-key")
        ...
        assert provider._agent_id == "clawbot"

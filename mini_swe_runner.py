#!/usr/bin/env python3
"""
SWE Runner with Clawbot Trajectory Format

A runner that uses Clawbot-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Clawbot-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Clawbot-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Clawbot format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Clawbot-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Clawbot-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Clawbot Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Clawbot-Agent's built-in execution environments
    and outputs trajectories in Clawbot-Agent format.
    """
    ...
    def _convert_to_clawbot_format(
        self,
        ...
        """
        Convert internal message format to Clawbot trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Clawbot trajectory format
        trajectory = self._convert_to_clawbot_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Clawbot trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Clawbot Trajectory Format")
    print("=" * 60)

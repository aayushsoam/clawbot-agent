...
Trust levels:
  - builtin:   Ships with Clawbot. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.clawbot/\.env|\~/\.clawbot/\.env',
     "clawbot_env_access", "critical", "exfiltration",
     "directly references Clawbot secrets file"),
    ...
    (r'\.clawbot/config\.yaml|\.clawbot/SOUL\.md',
     "clawbot_config_mod", "critical", "persistence",
     "references Clawbot configuration files directly"),

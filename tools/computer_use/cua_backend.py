...
PINNED_CUA_DRIVER_VERSION = os.environ.get("CLAWBOT_CUA_DRIVER_VERSION", "0.5.0")

_CUA_DRIVER_CMD = os.environ.get("CLAWBOT_CUA_DRIVER_CMD", "cua-driver")
...
def cua_driver_binary_available() -> bool:
    """True if `cua-driver` is on $PATH or CLAWBOT_CUA_DRIVER_CMD resolves."""
...
class CuaDriverBackend(ComputerUseBackend):
    ...
    def capture(self, mode: str = "som", app: Optional[str] = None) -> CaptureResult:
        ...
        Maps clawbot `capture(mode, app)` → cua-driver `list_windows` +

...
COMPUTER_USE_SCHEMA: Dict[str, Any] = {
    "name": "computer_use",
    "description": (
        "Drive a desktop in the background — screenshots, mouse, "
        ...
        "hidden, minimized, on another workspace/Space, or behind another app. "
        "Requires cua-driver to be installed; supported on macOS and Windows, "
        "with Linux support depending on the upstream cua-driver release."
    ),
    "parameters": {
        "type": "object",
        "properties": {

...
the get_anchored_view / get_messages_around primitives in clawbot_state.
...
toolkit expansion in PR #26419 (aayushsoam) added the anchored drill-down,
...
# Third-party integrations tag their sessions with CLAWBOT_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from clawbot_state import DEFAULT_DB_PATH

...
import type { ScrollBoxHandle } from '@clawbot/ink'
import { evictInkCaches } from '@clawbot/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.CLAWBOT_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }

 ...
 *
 * Symptom: in `clawbot --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@clawbot/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using clawbot --tui and as i type multiline my caret at the end will often ' +

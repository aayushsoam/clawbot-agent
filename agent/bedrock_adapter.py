"""AWS Bedrock Converse API adapter for Clawbot Agent.
...
# Upstream removed boto3 from [all] extras ; lazy_deps
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install Clawbot with Bedrock support: pip install -e '.[bedrock]'"
        )

 ...
 *
 * Plugins call window.__CLAWBOT_PLUGINS__.register(name, Component)
...
import { Badge } from "@aayushsoam/ui/ui/components/badge";
import { Button } from "@aayushsoam/ui/ui/components/button";
import { Select, SelectOption } from "@aayushsoam/ui/ui/components/select";
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { Separator } from "@/components/ui/separator";
import { Tabs, TabsList, TabsTrigger } from "@aayushsoam/ui/ui/components/tabs";
...
declare global {
  interface Window {
    __CLAWBOT_PLUGIN_SDK__: unknown;
    __CLAWBOT_PLUGINS__: {
...
export function exposePluginSDK() {
  window.__CLAWBOT_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__CLAWBOT_PLUGIN_SDK__ = {

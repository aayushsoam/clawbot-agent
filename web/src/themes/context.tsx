...
const STORAGE_KEY = "clawbot-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `clawbot_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "clawbot-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-clawbot-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-clawbot-theme-font", "true");

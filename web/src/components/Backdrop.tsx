import { useGpuTier } from "@aayushsoam/ui/hooks/use-gpu-tier";

/**
 * Replicates the visual layer stack of `<Overlays dark />` from
 * `@aayushsoam/ui` without pulling in its leva / gsap / three peer deps.
 *
 * See `design-language/src/ui/components/overlays/index.tsx` for the source of
 * truth. Defaults match LENS_0 (the Clawbot teal dark preset); the deep canvas

...
import { ListItem } from "@aayushsoam/ui/ui/components/list-item";
import { SelectionSwitcher } from "@aayushsoam/ui/ui/components/selection-switcher";
import { Spinner } from "@aayushsoam/ui/ui/components/spinner";
...
export default function App() {
  ...
  // asynchrosoamly from /api/dashboard/plugins, so on initial render
...
function SidebarSystemActions({ onNavigate }: { onNavigate: () => void }) {
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateClawbot,
      runningLabel: t.status.updatingClawbot,
      spin: false,
    },
  ];

...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateClawbot: "Clawbot'i Güncelle",
    updatingClawbot: "Clawbot güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Clawbot eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`clawbot plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.clawbot/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.clawbot/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.clawbot/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Clawbot rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "Clawbot oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Clawbot'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. Clawbot ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "Clawbot yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",

...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateClawbot: "Aggiorna Clawbot",
    updatingClawbot: "Aggiornamento di Clawbot…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Clawbot (parità con `clawbot plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.clawbot/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.clawbot/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.clawbot/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Clawbot da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Clawbot in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Clawbot di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Clawbot rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Clawbot sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",

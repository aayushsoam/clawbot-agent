...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateClawbot: "Werk Clawbot op",
    updatingClawbot: "Besig om Clawbot op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Clawbot-inproppe op (`clawbot plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.clawbot/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.clawbot/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.clawbot/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Clawbot-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Clawbot-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Clawbot meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Clawbot 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Clawbot skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",

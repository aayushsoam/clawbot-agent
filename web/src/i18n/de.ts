...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateClawbot: "Clawbot aktualisieren",
    updatingClawbot: "Clawbot wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Clawbot-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `clawbot plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.clawbot/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.clawbot/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.clawbot/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Clawbot-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Clawbot-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Clawbot mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Clawbot ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Clawbot scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",

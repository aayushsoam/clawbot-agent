"""Clawbot CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.clawbot/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    colors:
      banner_border: "#FF4500"            # Panel border color
      banner_title: "#FF6600"             # Panel title text color
      banner_accent: "#FF8C00"            # Section headers (Available Tools, etc.)
      banner_dim: "#CC5500"               # Dim/muted text (separators, labels)
      banner_text: "#FFE4C4"              # Body text (tool names, skill names)
      ui_accent: "#FF8C00"               # General UI accent
      ui_label: "#FF8C00"                # UI labels (warm orange; teal clashed w/ default banner orange)
      ui_ok: "#4caf50"                   # Success indicators
      ui_error: "#ef5350"                # Error indicators
      ui_warn: "#ffa726"                 # Warning indicators
      prompt: "#FFE4C4"                  # Prompt text color
      input_rule: "#FF4500"              # Input area horizontal rule
      response_border: "#FF6600"         # Response box border (ANSI)
      status_bar_bg: "#1a1a2e"           # Status bar background
      status_bar_text: "#C0C0C0"         # Status bar default text
      status_bar_strong: "#FF6600"       # Status bar highlighted text
      status_bar_dim: "#8B8682"          # Status bar separators/muted text
      status_bar_good: "#8FBC8F"         # Healthy context usage
      status_bar_warn: "#FF8C00"         # Warning context usage
      status_bar_bad: "#FF8C00"          # High context usage
      status_bar_critical: "#FF6B6B"     # Critical context usage
      session_label: "#FF8C00"           # Session label color
    ...
    branding:
      agent_name: "Clawbot Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚡"              # Shown on exit
      response_label: " ⚡Clawbot "       # Response box header label
...
.. code-block:: python
    ...
    from clawbot_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FF6600"
    print(skin.get_branding("agent_name"))  # "Clawbot Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.clawbot/skins/
...
Drop a YAML file in ``~/.clawbot/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces CLAWBOT_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces CLAWBOT_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Clawbot — orange and kawaii",
        "colors": {
...
def get_prompt_toolkit_style_overrides() -> Dict[str, str]:
    ...
    input_rule = skin.get_color("input_rule", "#FF4500")
    title = skin.get_color("banner_title", "#FF6600")
    text = skin.get_color("banner_text", "#FFE4C4")

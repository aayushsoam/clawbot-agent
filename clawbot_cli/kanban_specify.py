...
Used by ``clawbot kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``clawbot_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Clawbot Agent board.
...
def _profile_author() -> str:
    """Mirror of ``clawbot_cli.kanban._profile_author``. Kept local to

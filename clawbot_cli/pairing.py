...
Usage:
    clawbot pairing list              # Show all pending + approved users
    clawbot pairing approve <platform> <code>  # Approve a pairing code
    clawbot pairing revoke <platform> <user_id> # Revoke user access
    clawbot pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle clawbot pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: clawbot pairing {list|approve|revoke|clear-pending}")
        print("Run 'clawbot pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.clawbot/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'clawbot pairing list' to see pending codes.\n")

...
def _has_clawbot_agent_browser() -> bool:
    ...
    # install.sh installs globally into $CLAWBOT_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-ClawbotHome", str(get_clawbot_home()),
        ]
    else:

...
Invoked by ``clawbot kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Clawbot Agent board.
...
def _profile_author() -> str:
    """Mirror of ``clawbot_cli.kanban._profile_author``."""
    return (
        os.environ.get("CLAWBOT_PROFILE")

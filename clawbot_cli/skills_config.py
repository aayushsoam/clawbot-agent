"""
Skills configuration for Clawbot Agent.
`clawbot skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.clawbot/config.yaml under:
...
from clawbot_cli.config import cfg_get, load_config, save_config
from clawbot_cli.colors import Colors, color
from clawbot_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `clawbot skills`."""
    from clawbot_cli.curses_ui import curses_checklist

...
def _profile_user_agent() -> str:
    """Return a ``clawbot-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from clawbot_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"clawbot-cli/{_ver}"
    except Exception:
        return "clawbot-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # clawbot-cli UA so the catalog endpoint is reachable.

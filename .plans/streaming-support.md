# Streaming LLM Response Support for Clawbot Agent
...
```
CLAWBOT_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("CLAWBOT_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `clawbot_cli/config.py` | 1 | +streaming config defaults |
...
CLAWBOT_STREAMING_ENABLED=true
```

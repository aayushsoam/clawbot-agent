...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/aayushsoam/clawbot-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/clawbot-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://clawbot-agent.aayushsoam.com',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'https://github.com/aayushsoam/clawbot-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/Aayushsoam',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/Aayushsoam' },
            { label: 'GitHub Discussions', href: 'https://github.com/aayushsoam/clawbot-agent/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/aayushsoam/clawbot-agent' },
            { label: 'Aayush soam', href: 'https://github.com/aayushsoam' },
          ],
        },
      ],
      copyright: `Built by <a href="https://github.com/aayushsoam">Aayush soam</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {

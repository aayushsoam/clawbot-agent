---
title: "Openclaw Migration — Migrate a user's OpenClaw customization footprint into Clawbot Agent"
sidebar_label: "Openclaw Migration"
description: "Migrate a user's OpenClaw customization footprint into Clawbot Agent"
---
...
Migrate a user's OpenClaw customization footprint into Clawbot Agent. Imports Clawbot-compatible memories, SOUL.md, command allowlists, user skills, and selected workspace assets from ~/.openclaw, then reports exactly what could not be migrated and why.
...
| Related skills | [`clawbot-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-clawbot-agent) |

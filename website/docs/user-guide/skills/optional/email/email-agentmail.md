...
Give the agent its own dedicated email inbox via AgentMail. Send, receive, and manage email autonomously using agent-owned email addresses (e.g. clawbot-agent@agentmail.to).

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `clawbot skills install official/email/agentmail` |

---
title: "Telephony — Give Clawbot phone capabilities without core tool changes"
sidebar_label: "Telephony"
description: "Give Clawbot phone capabilities without core tool changes"
---
...
Give Clawbot phone capabilities without core tool changes. Provision and persist a Twilio number, send and receive SMS/MMS, make direct calls, and place AI-driven outbound calls through Bland.ai or Vapi.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `clawbot skills install official/productivity/telephony` |

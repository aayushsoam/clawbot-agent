...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Clawbot Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Clawbot Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Clawbot core? Start with [Build a Clawbot Plugin](../guides/build-a-clawbot-plugin.md)
- Building a new built-in core tool for Clawbot itself? Start with [Adding Tools](./adding-tools.md)
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.clawbot/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.clawbot` — use `get_clawbot_home()` from `clawbot_constants` for code paths and `display_clawbot_home()` for user-facing messages. See [AGENTS.md](https://github.com/aayushsoam/clawbot-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discord**: [discord.gg/Aayushsoam](https://discord.gg/Aayushsoam)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/aayushsoam/clawbot-agent/blob/main/LICENSE).

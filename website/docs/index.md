...
slug: /
sidebar_position: 0
title: "Clawbot Agent Documentation"
description: "The self-improving AI agent built by Aayush soam. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Aayush soam](https://github.com/aayushsoam). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.

<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  <a href="/docs/getting-started/installation" style={{display: 'inline-block', padding: '0.6rem 1.2rem', backgroundColor: '#FF6600', color: '#07070d', borderRadius: '8px', fontWeight: 600, textDecoration: 'none'}}>Get Started →</a>
  <a href="https://github.com/aayushsoam/clawbot-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Clawbot safely |
| 🧭 **[Use MCP with Clawbot](/docs/guides/use-mcp-with-clawbot)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Clawbot](/docs/guides/use-voice-mode-with-clawbot)** | Hands-on setup and usage patterns for Clawbot voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define Clawbot' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of Clawbot |
...
- **Built by model trainers** — Created by [Aayush soam](https://github.com/aayushsoam), the lab behind Clawbot, Nomos, and Psyche. Works with [Soam Portal](https://portal.aayushsoam.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Aayush soam](https://github.com/aayushsoam) — the lab behind Clawbot, Nomos, and Psyche models

  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Clawbot Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Clawbot &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Clawbot?{' '}
        <a
          href="https://github.com/aayushsoam/clawbot-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/Aayushsoam" target="_blank" rel="noopener noreferrer">
          Aayush soam Discord
        </a>{' '}

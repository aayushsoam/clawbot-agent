...
export function RightSidebarPane({ onActivateFile, onActivateFolder, onChangeCwd }: RightSidebarPaneProps) {
  ...
  return (
    <aside
      ...
      className={cn(
        'before:pointer-events-none relative flex h-full w-full min-w-0 flex-col overflow-hidden border-0 bg-transparent pt-(--titlebar-height) text-(--ui-text-tertiary)'
      )}
    >

...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/clawbot'
...
import { type AppView, ARTIFACTS_ROUTE, MESSAGING_ROUTE, PLUGINS_ROUTE, SKILLS_ROUTE } from '../../routes'
...
const SIDEBAR_NAV: SidebarNavItem[] = [
  ...
  { id: 'plugins', label: 'Plugins', icon: props => <Codicon name="plug" {...props} />, route: PLUGINS_ROUTE },
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('clawbot:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('clawbot:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])

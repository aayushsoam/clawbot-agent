...
import { deleteEnvVar, getToolsetConfig, revealEnvVar, selectToolsetProvider, setEnvVar } from '@/clawbot'
import { Check, Loader2, Save } from '@/lib/icons'
import { cn } from '@/lib/utils'
import { notify, notifyError } from '@/store/notifications'
import type { ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/clawbot'
...
export function ToolsetConfigPanel({ toolset, onConfiguredChange }: ToolsetConfigPanelProps) {
  ...
  // panel highlighted the first keyless provider (e.g. Clawbot Portal) even when
              ...
              <div className="grid gap-2 bg-muted/20 p-3">
                ...
                {provider.requires_nous_auth && (
                  <p className="text-[0.72rem] text-muted-foreground">
                    Included with a Clawbot subscription — sign in to Clawbot Portal to activate.
                  </p>
                )}
                ...
                {provider.post_setup && (
                  <p className="text-[0.72rem] text-muted-foreground">
                    ...
                    <code className="font-mono">clawbot tools</code> for now.
                  </p>
                )}
              </div>
            )}

import type { ClawbotConfigRecord, ToolsetInfo } from '@/types/clawbot'
...
export function getNested(obj: ClawbotConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ClawbotConfigRecord, path: string, value: unknown): ClawbotConfigRecord {
...
function personalityOptions(config: ClawbotConfigRecord): string[] {

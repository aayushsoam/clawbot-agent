...
import { getAuxiliaryModels, getGlobalModelInfo, getGlobalModelOptions, setModelAssignment } from '@/clawbot'
import type { AuxiliaryModelsResponse, ModelOptionProvider } from '@/clawbot'
...
// Mirrors `_AUX_TASK_SLOTS` in clawbot_cli/web_server.py. Friendly labels and

...
import { getClawbotConfigRecord, type ClawbotGateway, saveClawbotConfig } from '@/clawbot'
...
function getServers(config: ClawbotConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveClawbotConfig(nextConfig)

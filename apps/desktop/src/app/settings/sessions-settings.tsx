...
import { deleteSession, listSessions, setSessionArchived } from '@/clawbot'
import { sessionTitle } from '@/lib/chat-runtime'
import { triggerHaptic } from '@/lib/haptics'
import { Archive, ArchiveOff, FolderOpen, Loader2, Trash2 } from '@/lib/icons'
import { notify, notifyError } from '@/store/notifications'
import { setSessions } from '@/store/session'
import type { SessionInfo } from '@/types/clawbot'
...
// / Program Files), which buried any files Clawbot wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.clawbotDesktop` is
    ...
    const settings = window.clawbotDesktop?.settings
  ...
  return (
    <div className="mb-6">
      ...
      <ListRow
        ...
        description={dir || `Defaults to ${fallback || '~/clawbot-projects'}.`}

...
import { extractDroppedFiles, CLAWBOT_PATHS_MIME } from '@/app/chat/hooks/use-composer-actions'
import { ClarifyTool } from '@/components/assistant-ui/clarify-tool'
import { DirectiveContent, clawbotDirectiveFormatter } from '@/components/assistant-ui/directive-text'
...
import type { ClawbotGateway } from '@/clawbot'
...
const ResponseLoadingIndicator: FC = () => {
  ...
  return (
    <StatusRow data-slot="aui_response-loading" label="Clawbot is loading a response">

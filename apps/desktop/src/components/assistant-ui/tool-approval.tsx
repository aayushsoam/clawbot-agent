...
const ApprovalBar: FC<{ request: ApprovalRequest }> = ({ request }) => {
  ...
  // "Always allow" persists the pattern to ~/.clawbot/config.yaml permanently, so
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <code className="font-mono text-xs">~/.clawbot/config.yaml</code>). Clawbot won’t ask again for commands

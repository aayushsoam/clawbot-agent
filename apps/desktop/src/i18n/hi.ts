...
export const hi: Translations = {
  ...
  plugins: {
    ...en.plugins,
    loading: 'Plugins लोड हो रहे हैं...',
    loadFailed: 'Plugins लोड नहीं हुए',
    refresh: 'Plugins रीफ्रेश करें',
    refreshing: 'Plugins रीफ्रेश हो रहे हैं',
    search: 'Plugins search करें...',
    providersHeading: 'Providers',
    providersHint: 'चुनें कि नई sessions के लिए memory और context कौन-सा plugin चलाए।',
    memoryProviderLabel: 'Memory provider',
    contextEngineLabel: 'Context engine',
    providerDefault: '(default)',
    saveProviders: 'Providers सहेजें',
    savedProviders: 'Providers सहेजे गए',
    saveProvidersFailed: 'Providers सहेजने में विफल',
    installHeading: 'Plugin install करें',
    installHint: 'Agent plugin install करने के लिए GitHub owner/repo या पूरा URL डालें।',
    identifierLabel: 'Plugin identifier',
    forceReinstall: 'Force reinstall',
    enableAfterInstall: 'Install के बाद enable करें',
    installBtn: 'Install',
    installed: name => `${name} install हो गया`,
    installFailed: 'Install विफल',
    missingEnv: vars => `गायब environment variables: ${vars}`,
    rescanHint: 'फाइलें manually जोड़ी हैं? नए dashboard plugins के लिए rescan करें।',
    rescanBtn: 'Rescan',
    rescanned: count => `Rescan हुआ (${count})`,
    rescanFailed: 'Rescan विफल',
    pluginListHeading: 'Installed plugins',
    noPlugins: 'अभी कोई plugin install नहीं है।',
    ...
    authRequired: 'Auth ज़रूरी',
    enable: 'Enable',
    disable: 'Disable',
    update: 'Update',
    remove: 'हटाएं',
    enabledToast: 'Plugin enable हुआ',
    disabledToast: 'Plugin disable हुआ',
    updatedToast: 'Plugin update हुआ',
    shownToast: 'Sidebar में दिख रहा है',
    hiddenToast: 'Sidebar से छिपाया',
    removedToast: name => `${name} हटाया गया`,
    showInSidebar: 'Sidebar में दिखाएं',
    hideFromSidebar: 'Sidebar से छिपाएं',
    removeConfirmTitle: 'Plugin हटाएं?',
    removeConfirmDesc: name => `यह आपके agent से "${name}" plugin हटा देगा।`
  },
  composer: {
    ...en.composer,
    message: 'Message',

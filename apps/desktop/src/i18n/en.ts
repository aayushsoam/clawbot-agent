...
export const en: Translations = {
  ...
  boot: {
    ready: 'Clawbot Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Clawbot settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingClawbotDesktop: 'Starting Clawbot Desktop…'
    },
    errors: {
      backgroundExited: 'Clawbot background process exited.',
      backgroundExitedDuringStartup: 'Clawbot background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Clawbot backend is older than this desktop build and may not work correctly. Update to align them.',
    updateClawbot: 'Update Clawbot',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Clawbot Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Clawbot defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Clawbot follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Clawbot checks for updates automatically in the background and lets you know when one is ready.',
  ...
  plugins: {
    ...
    loadFailed: 'Plugins failed to load',
    refresh: 'Refresh plugins',
    refreshing: 'Refreshing plugins',
    search: 'Search plugins...',
    providersHeading: 'Providers',
    providersHint: 'Pick which plugin powers memory and context for new sessions.',
    ...
    installHint: 'Enter a GitHub owner/repo or a full URL to install an agent plugin.',
    ...
    missingEnv: vars => `Missing environment variables: ${vars}`,
    rescanHint: 'Already added files manually? Rescan to pick up new dashboard plugins.',
    rescanBtn: 'Rescan',
    rescanned: count => `Rescanned (${count})`,
    ...
    shownToast: 'Shown in sidebar',
    hiddenToast: 'Hidden from sidebar',
    removedToast: name => `${name} removed`,
    showInSidebar: 'Show in sidebar',
    hideFromSidebar: 'Hide from sidebar',
    removeConfirmTitle: 'Remove plugin?',
    removeConfirmDesc: name => `This will remove the "${name}" plugin from your agent.`
  },
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Clawbot desktop' },
    ...
    clawbotActiveSessions: (version, count) => `Clawbot ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Clawbot environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Clawbot will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    attachUrlDesc: 'Clawbot will fetch the page and include it as context for this turn.',

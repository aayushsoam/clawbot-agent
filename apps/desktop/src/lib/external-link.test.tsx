...
const desktopWindow = window as unknown as { clawbotDesktop?: Window['clawbotDesktop'] }
const initialClawbotDesktop = desktopWindow.clawbotDesktop

function installDesktopBridge(partial: Partial<Window['clawbotDesktop']> = {}) {
  desktopWindow.clawbotDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['clawbotDesktop']
}
...
afterEach(() => {
  ...
  if (initialClawbotDesktop) {
    desktopWindow.clawbotDesktop = initialClawbotDesktop
  } else {
    delete desktopWindow.clawbotDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['clawbotDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['clawbotDesktop']['openExternal'] })

...
import type { SessionInfo, UsageStats } from '@/types/clawbot'

type Updater<T> = T | ((current: T) => T)

const WORKSPACE_CWD_KEY = 'clawbot.desktop.workspace-cwd'
...
export const $connection = atom<ClawbotConnection | null>(null)
...
export const setConnection = (next: Updater<ClawbotConnection | null>) => updateAtom($connection, next)

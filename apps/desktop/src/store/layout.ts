...
const SIDEBAR_PINNED_STORAGE_KEY = 'clawbot.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'clawbot.desktop.agentsGroupedByWorkspace'
const PANES_FLIPPED_STORAGE_KEY = 'clawbot.desktop.panesFlipped'

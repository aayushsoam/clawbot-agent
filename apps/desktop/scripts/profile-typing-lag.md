...
cd apps/desktop
XCURSOR_SIZE=24 CLAWBOT_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/clawbot-typing
# → /tmp/clawbot-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/clawbot-typing.before.heapsnapshot
# → /tmp/clawbot-typing.after.heapsnapshot
```
